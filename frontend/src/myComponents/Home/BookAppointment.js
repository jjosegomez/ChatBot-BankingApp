...
const BookAppointment = () => {
  return (
    <Box sx={{display: "flex", flexFlow: "column", justifyContent:"center", justifyContent:"center", width:"90%",maxWidth:"1000px", margin: "auto", mb:5}}>
      <Typography sx={{mb:3}}>
      ...
      <Button
        ...
        variant="outlined" 
        sx={{margin:"auto", fontSize:"1.25rem", width:"200px", mb:2, mt:3}}>
        Book Now!
      </Button>
    </Box>
  );
